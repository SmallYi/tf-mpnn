...
#     tf.config.experimental.set_memory_growth(physical_devices[0], True)
    ...
    from tf_model2 import PFNet, prepare_df, PFNet2
    from tf_data import _parse_tfr_element
    tfr_files = glob.glob("/storage/group/gpu/bigdata/particleflow/TTbar_14TeV_TuneCUETP8M1_cfi/tfr3/cand/*.tfrecords")
...
#     model = PFNet(hidden_dim=args.nhidden, distance_dim=args.distance_dim, num_conv=args.num_conv, convlayer=args.convlayer)
    ...
    model = PFNet2(hidden_sizes = [128, 128], num_outputs = 128, state_dim = 16, update_steps = 3,hidden_dim=args.nhidden, distance_dim=args.distance_dim, num_conv=args.num_conv, convlayer=args.convlayer)
